...
public class CraftingManager {
	...
	private CraftingManager() {
		...
		this.addRecipe(new ItemStack(Block.clothRed, 1), new Object[]{"#X0", '#', Block.cloth, 'X', Block.plantRed});
		this.addRecipe(new ItemStack(Block.clothOrange, 1), new Object[]{"#X0", '#', Block.cloth, 'X', Block.plantOrange});
		this.addRecipe(new ItemStack(Block.clothYellow, 1), new Object[]{"#X0", '#', Block.cloth, 'X', Block.plantYellow});
		this.addRecipe(new ItemStack(Block.clothChartreuse, 1), new Object[]{"#X0", '#', Block.cloth, 'X', Block.plantChartreuse});
		this.addRecipe(new ItemStack(Block.clothGreen, 1), new Object[]{"#X0", '#', Block.cloth, 'X', Block.plantGreen});
		this.addRecipe(new ItemStack(Block.clothSpringGreen, 1), new Object[]{"#X0", '#', Block.cloth, 'X', Block.plantSpringGreen});
		this.addRecipe(new ItemStack(Block.clothCyan, 1), new Object[]{"#X0", '#', Block.cloth, 'X', Block.plantCyan});
		this.addRecipe(new ItemStack(Block.clothCapri, 1), new Object[]{"#X0", '#', Block.cloth, 'X', Block.plantCapri});
		this.addRecipe(new ItemStack(Block.clothUltramarine, 1), new Object[]{"#X0", '#', Block.cloth, 'X', Block.plantUltramarine});
		this.addRecipe(new ItemStack(Block.clothViolet, 1), new Object[]{"#X0", '#', Block.cloth, 'X', Block.plantViolet});
		this.addRecipe(new ItemStack(Block.clothPurple, 1), new Object[]{"#X0", '#', Block.cloth, 'X', Block.plantPurple});
		this.addRecipe(new ItemStack(Block.clothMagenta, 1), new Object[]{"#X0", '#', Block.cloth, 'X', Block.plantMagenta});
		this.addRecipe(new ItemStack(Block.clothRose, 1), new Object[]{"#X0", '#', Block.cloth, 'X', Block.plantRose});
	...
	void addRecipe(ItemStack itemStack1, Object[] object2) {
		...
		if(object2[i4] instanceof String[]) {
			...
			for(i8 = 0; i8 < string11.length; ++i8) {
		...
		for(hashMap12 = new HashMap(); i4 < object2.length; i4 += 2) {
			...
			if(object2[i4 + 1] instanceof Item) {
				i8 = ((Item)object2[i4 + 1]).shiftedIndex;
			} else if(object2[i4 + 1] instanceof Block) {
				i8 = ((Block)object2[i4 + 1]).blockID;
			}

			hashMap12.put(character13, i8);
		}

		int[] i14 = new int[i5 * i6];

		for(i8 = 0; i8 < i5 * i6; ++i8) {
			char c10 = string3.charAt(i8);
			if(hashMap12.containsKey(c10)) {
				i14[i8] = ((Integer)hashMap12.get(c10)).intValue();
			} else {
				i14[i8] = -1;
			}
		}
