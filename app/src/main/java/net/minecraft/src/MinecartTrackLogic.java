...
class MinecartTrackLogic {
	...
	public MinecartTrackLogic(iffix iffix1, World world2, int i3, int i4, int i5) {
		this.a = iffix1;
	...
	private boolean isMinecartTrack(int x, int y, int z) {
		return this.worldObj.getBlockId(x, y, z) == this.a.blockID ? true : (this.worldObj.getBlockId(x, y + 1, z) == this.a.blockID ? true : this.worldObj.getBlockId(x, y - 1, z) == this.a.blockID);
	}
