...
public interface IWorldAccess {
	...
	void makeAmbience(String string1, double d2, double d4, double d6, float f8, float f9);

	void updateAmbience(String string1, double d2, double d4, double d6, float f8, float f9);
