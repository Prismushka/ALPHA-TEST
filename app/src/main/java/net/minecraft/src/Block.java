...
public class Block {
	...
	public static final Block clothRed = (new Block(21, 113, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothOrange = (new Block(22, 129, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothYellow = (new Block(23, 145, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothChartreuse = (new Block(24, 161, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothGreen = (new Block(25, 177, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothSpringGreen = (new Block(26, 193, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothCyan = (new Block(27, 209, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothCapri = (new Block(28, 225, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothUltramarine = (new Block(29, 114, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothViolet = (new Block(30, 130, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothPurple = (new Block(31, 146, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothMagenta = (new Block(32, 162, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothRose = (new Block(33, 178, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothDarkGray = (new Block(34, 194, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block cloth = (new Block(35, 64, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	public static final Block clothGray = (new Block(36, 210, Material.cloth)).setHardness(0.8F).setStepSound(soundClothFootstep);
	...
	public static final Block minecartTrack = (new iffix(66, 128)).setHardness(0.7F).setStepSound(soundMetalFootstep);
	...
	public static final BlockFlower plantOrange = (BlockFlower)(new BlockFlower(86, 132)).setHardness(0.0F).setStepSound(soundGrassFootstep);
	public static final BlockFlower plantChartreuse = (BlockFlower)(new BlockFlower(87, 164)).setHardness(0.0F).setStepSound(soundGrassFootstep);
	public static final BlockFlower plantGreen = (BlockFlower)(new BlockFlower(88, 180)).setHardness(0.0F).setStepSound(soundGrassFootstep);
	public static final BlockFlower plantSpringGreen = (BlockFlower)(new BlockFlower(89, 196)).setHardness(0.0F).setStepSound(soundGrassFootstep);
	public static final BlockFlower plantCyan = (BlockFlower)(new BlockFlower(90, 212)).setHardness(0.0F).setStepSound(soundGrassFootstep);
	public static final BlockFlower plantCapri = (BlockFlower)(new BlockFlower(91, 228)).setHardness(0.0F).setStepSound(soundGrassFootstep);
	public static final BlockFlower plantUltramarine = (BlockFlower)(new BlockFlower(92, 117)).setHardness(0.0F).setStepSound(soundGrassFootstep);
	public static final BlockFlower plantViolet = (BlockFlower)(new BlockFlower(93, 133)).setHardness(0.0F).setStepSound(soundGrassFootstep);
	public static final BlockFlower plantPurple = (BlockFlower)(new BlockFlower(94, 149)).setHardness(0.0F).setStepSound(soundGrassFootstep);
	public static final BlockFlower plantMagenta = (BlockFlower)(new BlockFlower(95, 165)).setHardness(0.0F).setStepSound(soundGrassFootstep);
	public static final BlockFlower plantRose = (BlockFlower)(new BlockFlower(96, 181)).setHardness(0.0F).setStepSound(soundGrassFootstep);
	...
	public MovingObjectPosition collisionRayTrace(World worldObj, int x, int y, int z, Vec3D vector1, Vec3D vector2) {
		this.canPlaceBlockAt(worldObj, x, y, z);
