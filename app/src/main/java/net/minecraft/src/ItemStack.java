...
public final class ItemStack {
	...
	public ItemTooltip getTooltip() {
		return ItemTooltip.fromMetadata[this.itemID] != null && ItemTooltip.fromMetadata[this.itemID][Math.max(this.itemMetadata, 0)] != null ? ItemTooltip.fromMetadata[this.itemID][Math.max(this.itemMetadata, 0)] : Item.itemsList[this.itemID].getTooltip();
	}
