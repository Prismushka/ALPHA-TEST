...
public class NetClientHandler extends NetHandler {
	...
	public void addToPlayerList(String string1, int i2) {
		this.players.add(new PlayerScore(string1, i2));
	}

	public int getIndexInPlayerList(String string1) {
		for(int i2 = 0; i2 < this.players.size(); ++i2) {
			if(((PlayerScore)this.players.get(i2)).playerName.equals(string1)) {
				return i2;
			}
		}
	...
	public void updatePlayerScore(String string1, int i2) {
		if(this.getIndexInPlayerList(string1) != -1) {
			((PlayerScore)this.players.get(this.getIndexInPlayerList(string1))).setScore(i2);
		}

	}

	public void removeFromPlayerList(String string1) {
		if(this.getIndexInPlayerList(string1) != -1) {
			this.players.remove(this.getIndexInPlayerList(string1));
		}
