...
public class EntityRenderer {
	...
	private void orientCamera(float renderPartialTick) {
		...
		if(this.mc.options.thirdPersonView > 0) {
			...
			float f13 = 0.0F;
			double d14 = (double)(-MathHelper.sin(f11 / 180.0F * (float)Math.PI) * MathHelper.cos(f12 / 180.0F * (float)Math.PI)) * d9;
			double d16 = (double)(MathHelper.cos(f11 / 180.0F * (float)Math.PI) * MathHelper.cos(f12 / 180.0F * (float)Math.PI)) * d9;
			double d18 = (double)(-MathHelper.sin(f12 / 180.0F * (float)Math.PI)) * d9;
			if(this.mc.options.thirdPersonView == 2) {
				d14 = (double)(-MathHelper.sin((f11 + 180.0F) / 180.0F * (float)Math.PI) * MathHelper.cos(-f12 / 180.0F * (float)Math.PI)) * d9;
				d16 = (double)(MathHelper.cos((f11 + 180.0F) / 180.0F * (float)Math.PI) * MathHelper.cos(-f12 / 180.0F * (float)Math.PI)) * d9;
				d18 = (double)(-MathHelper.sin(-f12 / 180.0F * (float)Math.PI)) * d9;
			}
			...
			GL11.glRotatef(entityPlayerSP2.rotationYaw - f11 + f13, 0.0F, 1.0F, 0.0F);
