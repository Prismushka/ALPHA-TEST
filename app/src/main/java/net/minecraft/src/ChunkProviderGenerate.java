...
public class ChunkProviderGenerate implements IChunkProvider {
	...
	public void populate(IChunkProvider chunkProvider, int chunkX, int chunkZ) {
		...
		Object object16 = new WorldGenTrees();
		if(this.rand.nextInt(10) == 0) {
			object16 = new WorldGenBigTree();
		}
		...
		for(i14 = 0; i14 < i12; ++i14) {
			...
			((WorldGenerator)object16).setScale(1.0D, 1.0D, 1.0D);
			((WorldGenerator)object16).generate(this.worldObj, this.rand, i15, this.worldObj.getHeightValue(i15, i17), i17);
		}
		...
		for(i14 = 0; i14 < 2; ++i14) {
			...
			i18 = i5 + this.rand.nextInt(16) + 8;
			(new WorldGenFlowers(Block.plantYellow.blockID)).generate(this.worldObj, this.rand, i15, i17, i18);
		}
		...
		if(this.rand.nextInt(2) == 0) {
			...
			i17 = i5 + this.rand.nextInt(16) + 8;
			(new WorldGenFlowers(Block.plantRed.blockID)).generate(this.worldObj, this.rand, i14, i15, i17);
		}
		...
		if(this.rand.nextInt(2) == 0) {
			...
			i15 = this.rand.nextInt(128);
			i17 = i5 + this.rand.nextInt(16) + 8;
			(new WorldGenFlowers(Block.plantRose.blockID)).generate(this.worldObj, this.rand, i14, i15, i17);
		}
		...
		if(this.rand.nextInt(2) == 0) {
			...
			i15 = this.rand.nextInt(128);
			i17 = i5 + this.rand.nextInt(16) + 8;
			(new WorldGenFlowers(Block.plantMagenta.blockID)).generate(this.worldObj, this.rand, i14, i15, i17);
		}
		...
		if(this.rand.nextInt(2) == 0) {
			...
			i15 = this.rand.nextInt(128);
			i17 = i5 + this.rand.nextInt(16) + 8;
			(new WorldGenFlowers(Block.plantPurple.blockID)).generate(this.worldObj, this.rand, i14, i15, i17);
		}
		...
		if(this.rand.nextInt(2) == 0) {
			...
			i15 = this.rand.nextInt(128);
			i17 = i5 + this.rand.nextInt(16) + 8;
			(new WorldGenFlowers(Block.plantViolet.blockID)).generate(this.worldObj, this.rand, i14, i15, i17);
		}
		...
		if(this.rand.nextInt(2) == 0) {
			...
			i15 = this.rand.nextInt(128);
			i17 = i5 + this.rand.nextInt(16) + 8;
			(new WorldGenFlowers(Block.plantUltramarine.blockID)).generate(this.worldObj, this.rand, i14, i15, i17);
		}
		...
		if(this.rand.nextInt(2) == 0) {
			...
			i15 = this.rand.nextInt(128);
			i17 = i5 + this.rand.nextInt(16) + 8;
			(new WorldGenFlowers(Block.plantCapri.blockID)).generate(this.worldObj, this.rand, i14, i15, i17);
		}
		...
		if(this.rand.nextInt(2) == 0) {
			...
			i15 = this.rand.nextInt(128);
			i17 = i5 + this.rand.nextInt(16) + 8;
			(new WorldGenFlowers(Block.plantCyan.blockID)).generate(this.worldObj, this.rand, i14, i15, i17);
		}
		...
		if(this.rand.nextInt(2) == 0) {
			...
			i15 = this.rand.nextInt(128);
			i17 = i5 + this.rand.nextInt(16) + 8;
			(new WorldGenFlowers(Block.plantSpringGreen.blockID)).generate(this.worldObj, this.rand, i14, i15, i17);
		}
		...
		if(this.rand.nextInt(2) == 0) {
			...
			i15 = this.rand.nextInt(128);
			i17 = i5 + this.rand.nextInt(16) + 8;
			(new WorldGenFlowers(Block.plantOrange.blockID)).generate(this.worldObj, this.rand, i14, i15, i17);
		}
		...
		if(this.rand.nextInt(2) == 0) {
			...
			i15 = this.rand.nextInt(128);
			i17 = i5 + this.rand.nextInt(16) + 8;
			(new WorldGenFlowers(Block.plantChartreuse.blockID)).generate(this.worldObj, this.rand, i14, i15, i17);
		}
		...
		if(this.rand.nextInt(2) == 0) {
			...
			i15 = this.rand.nextInt(128);
			i17 = i5 + this.rand.nextInt(16) + 8;
			(new WorldGenFlowers(Block.plantGreen.blockID)).generate(this.worldObj, this.rand, i14, i15, i17);
		}
		...
		if(this.rand.nextInt(4) == 0) {
			...
			i15 = this.rand.nextInt(128);
			i17 = i5 + this.rand.nextInt(16) + 8;
			(new WorldGenFlowers(Block.mushroomBrown.blockID)).generate(this.worldObj, this.rand, i14, i15, i17);
		}
		...
		if(this.rand.nextInt(8) == 0) {
			...
			i15 = this.rand.nextInt(128);
			i17 = i5 + this.rand.nextInt(16) + 8;
			(new WorldGenFlowers(Block.mushroomRed.blockID)).generate(this.worldObj, this.rand, i14, i15, i17);
		}
		...
		for(i14 = 0; i14 < 10; ++i14) {
			...
			i17 = this.rand.nextInt(128);
			i18 = i5 + this.rand.nextInt(16) + 8;
			(new WorldGenReed()).generate(this.worldObj, this.rand, i15, i17, i18);
		}
		...
		for(i14 = 0; i14 < 1; ++i14) {
			...
			i17 = this.rand.nextInt(128);
			i18 = i5 + this.rand.nextInt(16) + 8;
			(new WorldGenCactus()).generate(this.worldObj, this.rand, i15, i17, i18);
		}

		for(i14 = 0; i14 < 50; ++i14) {
			i15 = i4 + this.rand.nextInt(16) + 8;
			i17 = this.rand.nextInt(this.rand.nextInt(120) + 8);
			i18 = i5 + this.rand.nextInt(16) + 8;
			(new WorldGenLiquids(Block.waterMoving.blockID)).generate(this.worldObj, this.rand, i15, i17, i18);
		}

		for(i14 = 0; i14 < 20; ++i14) {
			i15 = i4 + this.rand.nextInt(16) + 8;
			i17 = this.rand.nextInt(this.rand.nextInt(this.rand.nextInt(112) + 8) + 8);
			i18 = i5 + this.rand.nextInt(16) + 8;
			(new WorldGenLiquids(Block.lavaMoving.blockID)).generate(this.worldObj, this.rand, i15, i17, i18);
		}

		for(i14 = i4 + 8 + 0; i14 < i4 + 8 + 16; ++i14) {
			for(i15 = i5 + 8 + 0; i15 < i5 + 8 + 16; ++i15) {
				i17 = this.worldObj.getTopSolidOrLiquidBlock(i14, i15);
				if(this.worldObj.snowCovered && i17 > 0 && i17 < 128 && this.worldObj.getBlockId(i14, i17, i15) == 0 && this.worldObj.getBlockMaterial(i14, i17 - 1, i15).getIsSolid() && this.worldObj.getBlockMaterial(i14, i17 - 1, i15) != Material.ice) {
					this.worldObj.setBlockWithNotify(i14, i17, i15, Block.snow.blockID);
				}
			}
		}
