...
public class Item {
	...
	public static Item EraserTool = (new ItemEraser(91, 200)).setIconIndex(89);
	...
	public static Item recordMagnet = (new ItemRecord(2002, "magnet")).setIconIndex(242);
	public static Item recordStal = (new ItemRecord(2003, "stal")).setIconIndex(243);
	public final int shiftedIndex;
	protected int maxStackSize = 64;
	protected int maxDamage = 32;
	protected int iconIndex;
	protected boolean bFull3D = true;
