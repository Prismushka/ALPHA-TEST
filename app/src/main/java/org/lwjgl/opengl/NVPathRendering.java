...
public final class NVPathRendering {
	...
	public static void glPathCommandsNV(int path, ByteBuffer commands, FloatBuffer coords) {
		...
		nglPathCommandsNV(path, commands.remaining(), MemoryUtil.getAddress(commands), coords.remaining(), GL11.GL_FLOAT, MemoryUtil.getAddress(coords), function_pointer);
	}
	public static void glPathCommandsNV(int path, ByteBuffer commands, boolean unsigned, ByteBuffer coords) {
		...
		BufferChecks.checkDirect(commands);
		BufferChecks.checkDirect(coords);
		nglPathCommandsNV(path, commands.remaining(), MemoryUtil.getAddress(commands), coords.remaining(), unsigned ? GL11.GL_UNSIGNED_BYTE : GL11.GL_BYTE, MemoryUtil.getAddress(coords), function_pointer);
	}
	public static void glPathCommandsNV(int path, ByteBuffer commands, boolean unsigned, ShortBuffer coords) {
		...
		BufferChecks.checkDirect(commands);
		BufferChecks.checkDirect(coords);
		nglPathCommandsNV(path, commands.remaining(), MemoryUtil.getAddress(commands), coords.remaining(), unsigned ? GL11.GL_UNSIGNED_SHORT : GL11.GL_SHORT, MemoryUtil.getAddress(coords), function_pointer);
	}
	...
	public static void glPathCoordsNV(int path, FloatBuffer coords) {
		...
		BufferChecks.checkFunctionAddress(function_pointer);
		BufferChecks.checkDirect(coords);
		nglPathCoordsNV(path, coords.remaining(), GL11.GL_FLOAT, MemoryUtil.getAddress(coords), function_pointer);
	}
	public static void glPathCoordsNV(int path, boolean unsigned, ByteBuffer coords) {
		...
		BufferChecks.checkFunctionAddress(function_pointer);
		BufferChecks.checkDirect(coords);
		nglPathCoordsNV(path, coords.remaining(), unsigned ? GL11.GL_UNSIGNED_BYTE : GL11.GL_BYTE, MemoryUtil.getAddress(coords), function_pointer);
	}
	public static void glPathCoordsNV(int path, boolean unsigned, ShortBuffer coords) {
		...
		BufferChecks.checkFunctionAddress(function_pointer);
		BufferChecks.checkDirect(coords);
		nglPathCoordsNV(path, coords.remaining(), unsigned ? GL11.GL_UNSIGNED_SHORT : GL11.GL_SHORT, MemoryUtil.getAddress(coords), function_pointer);
	}
	...
	public static void glPathSubCommandsNV(int path, int commandStart, int commandsToDelete, ByteBuffer commands, FloatBuffer coords) {
		...
		BufferChecks.checkDirect(commands);
		BufferChecks.checkDirect(coords);
		nglPathSubCommandsNV(path, commandStart, commandsToDelete, commands.remaining(), MemoryUtil.getAddress(commands), coords.remaining(), GL11.GL_FLOAT, MemoryUtil.getAddress(coords), function_pointer);
	}
	public static void glPathSubCommandsNV(int path, int commandStart, int commandsToDelete, ByteBuffer commands, boolean unsigned, ByteBuffer coords) {
		...
		BufferChecks.checkDirect(commands);
		BufferChecks.checkDirect(coords);
		nglPathSubCommandsNV(path, commandStart, commandsToDelete, commands.remaining(), MemoryUtil.getAddress(commands), coords.remaining(), unsigned ? GL11.GL_UNSIGNED_BYTE : GL11.GL_BYTE, MemoryUtil.getAddress(coords), function_pointer);
	}
	public static void glPathSubCommandsNV(int path, int commandStart, int commandsToDelete, ByteBuffer commands, boolean unsigned, ShortBuffer coords) {
		...
		BufferChecks.checkDirect(commands);
		BufferChecks.checkDirect(coords);
		nglPathSubCommandsNV(path, commandStart, commandsToDelete, commands.remaining(), MemoryUtil.getAddress(commands), coords.remaining(), unsigned ? GL11.GL_UNSIGNED_SHORT : GL11.GL_SHORT, MemoryUtil.getAddress(coords), function_pointer);
	}
	...
	public static void glPathSubCoordsNV(int path, int coordStart, FloatBuffer coords) {
		...
		BufferChecks.checkFunctionAddress(function_pointer);
		BufferChecks.checkDirect(coords);
		nglPathSubCoordsNV(path, coordStart, coords.remaining(), GL11.GL_FLOAT, MemoryUtil.getAddress(coords), function_pointer);
	}
	public static void glPathSubCoordsNV(int path, int coordStart, boolean unsigned, ByteBuffer coords) {
		...
		BufferChecks.checkFunctionAddress(function_pointer);
		BufferChecks.checkDirect(coords);
		nglPathSubCoordsNV(path, coordStart, coords.remaining(), unsigned ? GL11.GL_UNSIGNED_BYTE : GL11.GL_BYTE, MemoryUtil.getAddress(coords), function_pointer);
	}
	public static void glPathSubCoordsNV(int path, int coordStart, boolean unsigned, ShortBuffer coords) {
		...
		BufferChecks.checkFunctionAddress(function_pointer);
		BufferChecks.checkDirect(coords);
		nglPathSubCoordsNV(path, coordStart, coords.remaining(), unsigned ? GL11.GL_UNSIGNED_SHORT : GL11.GL_SHORT, MemoryUtil.getAddress(coords), function_pointer);
	}
	...
	public static void glStencilFillPathInstancedNV(int pathNameType, ByteBuffer paths, int pathBase, int fillMode, int mask, int transformType, FloatBuffer transformValues) {
		...
		nglStencilFillPathInstancedNV(numPaths, pathNameType, MemoryUtil.getAddress(paths), pathBase, fillMode, mask, transformType, MemoryUtil.getAddressSafe(transformValues), function_pointer);
	}
	...
	public static void glStencilStrokePathInstancedNV(int pathNameType, ByteBuffer paths, int pathBase, int reference, int mask, int transformType, FloatBuffer transformValues) {
		...
		if (transformValues != null)
			BufferChecks.checkBuffer(transformValues, numPaths * GLChecks.calculateTransformPathValues(transformType));
		nglStencilStrokePathInstancedNV(numPaths, pathNameType, MemoryUtil.getAddress(paths), pathBase, reference, mask, transformType, MemoryUtil.getAddressSafe(transformValues), function_pointer);
	}
	...
	static native void nglPathTexGenNV(int texCoordSet, int genMode, int components, long coeffs, long function_pointer);
	...
	public static void glCoverFillPathInstancedNV(int pathNameType, ByteBuffer paths, int pathBase, int coverMode, int transformType, FloatBuffer transformValues) {
		...
		if (transformValues != null)
			BufferChecks.checkBuffer(transformValues, numPaths * GLChecks.calculateTransformPathValues(transformType));
		nglCoverFillPathInstancedNV(numPaths, pathNameType, MemoryUtil.getAddress(paths), pathBase, coverMode, transformType, MemoryUtil.getAddressSafe(transformValues), function_pointer);
	}
	...
	public static void glCoverStrokePathInstancedNV(int pathNameType, ByteBuffer paths, int pathBase, int coverMode, int transformType, FloatBuffer transformValues) {
		...
		if (transformValues != null)
			BufferChecks.checkBuffer(transformValues, numPaths * GLChecks.calculateTransformPathValues(transformType));
		nglCoverStrokePathInstancedNV(numPaths, pathNameType, MemoryUtil.getAddress(paths), pathBase, coverMode, transformType, MemoryUtil.getAddressSafe(transformValues), function_pointer);
	}
	...
	public static void glGetPathMetricsNV(int metricQueryMask, int pathNameType, ByteBuffer paths, int pathBase, int stride, FloatBuffer metrics) {
		...
		nglGetPathMetricsNV(metricQueryMask, numPaths, pathNameType, MemoryUtil.getAddress(paths), pathBase, stride, MemoryUtil.getAddress(metrics), function_pointer);
	}
